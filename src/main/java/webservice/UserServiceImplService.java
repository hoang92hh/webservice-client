 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://webservice/", wsdlLocation = "http://localhost:8080/ws/users?wsdl")
    ...
    extends Service
{
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://webservice/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice/", "UserServiceImplPort"), UserService.class, features);
    }
